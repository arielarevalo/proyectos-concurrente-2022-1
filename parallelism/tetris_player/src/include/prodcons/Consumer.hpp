...
public:
	...
	Queue<DataType>* getConsumingQueue();

	/// Set the queue where this thread will consume elements
	void setConsumingQueue(Queue<DataType>* consumingQueue);
...
template<typename DataType>
Consumer<DataType>::Consumer(Queue<DataType>* consumingQueue,
		const DataType& stopCondition,
		bool createOwnQueue)
...
template<typename DataType>
Queue<DataType>* Consumer<DataType>::getConsumingQueue()
{
	return this->consumingQueue;
}

template<typename DataType>
void Consumer<DataType>::setConsumingQueue(Queue<DataType>* consumingQueue)
{
	this->consumingQueue = consumingQueue;
}

template<typename DataType>
void Consumer<DataType>::createOwnQueue()
{
...
template<typename DataType>
void Consumer<DataType>::consumeForever()
{
